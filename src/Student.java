...
public class Student {
            ...
            throws SQLException, ClassNotFoundException
    {
        ...
        String sql = "SELECT student.StudentId, class.NameClass,student.Name FROM student LEFT JOIN class ON student.ClassId = class.ClassId LIMIT "+pageSize+" OFFSET "+count+"";
