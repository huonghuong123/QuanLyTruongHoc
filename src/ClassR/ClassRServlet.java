 ...
 */
@WebServlet(urlPatterns = {"/Class", "/class", "/lop"})
public class ClassRServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("DataTable",ClassR.List());
            request.setAttribute("web_title","List Class");
            request.setAttribute("web_content","ClassR/ClassR.jsp");
